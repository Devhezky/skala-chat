        ...
        Route::namespace('User')->group(function () {
            ...
            Route::controller('AutomationController')->prefix('automation')->name('automation.')->group(function () {
                ...
                Route::middleware('has.subscription')->group(function () {
                    ...
                    // New AI Configuration Routes
                    Route::post('ai-assistant/fetch-url', 'fetchUrl')->name('ai.assistant.fetch-url');
                    Route::post('ai-assistant/store-source', 'storeSource')->name('ai.assistant.store-source');
                    Route::post('ai-assistant/delete-source/{id}', 'deleteSource')->name('ai.assistant.delete-source');
                    Route::post('ai-assistant/save-agent-config', 'saveAgentConfig')->name('ai.assistant.save-agent-config');
                    Route::post('ai-assistant/chat', 'chat')->name('ai.assistant.chat');
