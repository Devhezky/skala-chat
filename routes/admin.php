...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('AiConfigurationController')->middleware('permission:ai assistant settings,admin')->name('ai-assistant.config.')->prefix('ai-assistant/config')->group(function () {
        Route::get('manage/{id}', 'manage')->name('manage');
        Route::post('fetch-url/{id}', 'fetchUrl')->name('fetch-url');
        Route::post('store-source/{id}', 'storeSource')->name('store-source');
        Route::post('delete-source/{id}', 'deleteSource')->name('delete-source');
        Route::post('save-agent-config/{id}', 'saveAgentConfig')->name('save-agent-config');
